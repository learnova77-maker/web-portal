...
export default function CreateBlogPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await push(ref(rtdb, 'blogs'), blogData);
            router.push('/blogs');
        } catch (err: any) {
                ...
                <header className="bg-zinc-950 border-b border-cyan-500/10 px-8 py-6 sticky top-0 z-10 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 mt-1 font-medium italic text-xs">Write and publish a new post.</p>
                        </div>
                    </div>
                    <button
                            ...
                            <div>
                                ...
                                <div className="bg-white rounded-2xl overflow-hidden border border-white/10 text-black">
                                    <ReactQuill 
                                        ...
                                        onChange={setContent}
                                        modules={modules}
                                        className="h-[400px] mb-12" // mb-12 is needed because quill toolbar is absolute/flex and bottom part gets hidden sometimes, or just standard height
                                    />
                                </div>
                                <style jsx global>{`
                                    .ql-container {
